...
class PromptManager:
    ...
    async def create_prompt(self, story_data: Dict[str, Any], hero_name: str) -> str:
        """
        Generates a complete prompt using Jinja2 templates.
        ...
        try:
            ...
            response_template = await self.load_template('templates/story.template')
            ...
            story = story_prompt.render(**story_context)
            response = response_template.render(**story_context)

            full_prompt = story + response
